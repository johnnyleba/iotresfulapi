package com.sk.iotresfulapi.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.sk.iotresfulapi.service.EmailAlreadyUsedException ||
            ex instanceof com.sk.iotresfulapi.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.sk.iotresfulapi.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.sk.iotresfulapi");
    }
}
